# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-04-20 08:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('db_host', models.IntegerField(default='1000000')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cmdb.InceptionWorkOrderInfo', to_field='work_order_id')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('r_time', models.DateTimeField(auto_now_add=True)),
                ('back_pool_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cmdb.BackupPoolInfo')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='work_order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cmdb.InceptionWorkOrderInfo', to_field='work_order_id'),
        ),
        migrations.AddField(
            model_name='backupedinfo',
            name='machine_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cmdb.MysqlBackupSourceInfo'),
        ),
        migrations.AddField(
